...
{
    public class GetAllStarsRequestHandler : IRequestHandler<IList<StarInfo>, GetAllStarsRequest>
    {
        public IList<StarInfo> Execute(GetAllStarsRequest request)
        {
            IList<StarInfo> starsInfo = new List<StarInfo>();
